	...
	WebMessage.prototype.printName = function(event)
	{
		console.log(this.name);
	};	
	
	WebMessage.prototype.connectionCB = function(event)
	{
		console.log(event);
	};	
	
	WebMessage.prototype.connectionOpen = function(event)
	{
		this.connected = true;
		console.log(event);
		this.connectionCB(event);
	};
	
		
	WebMessage.prototype.transfer = function(message){
	...
	WebMessage.prototype.onMessage = function(event)
	{
		console.log(event.data);
	};
		
		
	WebMessage.prototype.initWithIp = function(ip){
		if(this.connected == false)
		{
			...
			//this.connectionCB =  this.__bind(onOpen,this);
		}
		else{
			this.socket.close();
			this.socket = new WebSocket(ip);
